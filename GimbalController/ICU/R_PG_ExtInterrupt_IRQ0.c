...
******************************************************************************
* File Name    : R_PG_ExtInterrupt_IRQ0.c
* Version      : 1.00
* Device(s)    : 
* Tool-Chain   : 
* H/W Platform : 
...
******************************************************************************/
#include "R_PG_ExtInterrupt_IRQ0.h"
...
* Include      : 
*
* Declaration  : bool R_PG_ExtInterrupt_Set_IRQ0(void)
*
* Function Name: R_PG_ExtInterrupt_Set_IRQ0
*
...
* Include      : 
*
* Declaration  : bool R_PG_ExtInterrupt_Disable_IRQ0(void)
*
* Function Name: R_PG_ExtInterrupt_Disable_IRQ0
*
...
* Include      : 
*
* Declaration  : bool R_PG_ExtInterrupt_GetRequestFlag_IRQ0(bool * flag)
*
* Function Name: R_PG_ExtInterrupt_GetRequestFlag_IRQ0
*
...
* Include      : 
*
* Declaration  : bool R_PG_ExtInterrupt_ClearRequestFlag_IRQ0(void)
*
* Function Name: R_PG_ExtInterrupt_ClearRequestFlag_IRQ0
*
